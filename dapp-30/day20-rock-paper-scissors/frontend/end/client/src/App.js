...
function App() {
  ...
  async function updateBet() {
    ...
    console.log(await contract.methods.currentState().call());
    console.log('iudpateBet');
    console.log(bet);
    setBet({count: bet[0], size: bet[1], admin: bet[2], state: bet[3]});
  }
  ...
  async function createBet(e) {
    const count = e.target.elements[1].value;
