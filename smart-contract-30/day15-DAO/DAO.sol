...
//Rename voter to investor
//Add Ether balance for investorks=utors
//Add share to investor. based on ether invested and smart contract balance
//In proposal add address fielf
//Add voter wieight, depending on ether balance
//When a vote is ended, funds are sent to the address
//From time to time, funds will come back to the contract (i.e fund manager send back money)
//Investor can withdraw money at any time. Ether given depends on share
